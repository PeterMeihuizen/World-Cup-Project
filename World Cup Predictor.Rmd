...
Ok now I need to web scrape and clean the data set for the 2023 Rugby World Cup fixtures.  

```{r}

url_1 <- "https://www.skysports.com/rugby-union/news/12337/12738029/rugby-world-cup-2023-fixtures-schedule-and-kick-off-times-for-england-wales-ireland-scotland-and-more-in-france"

page <- read_html(url_1)

# Identify the HTML elements containing the fixtures
fixture_elements <- page %>% html_nodes("Fixtures and UK kick-off times")

# Extract the fixture information from the HTML elements
fixtures <- fixture_elements %>% html_text()

# Convert the fixtures into a table
fixtures_table <- data.frame(Fixtures = fixtures)

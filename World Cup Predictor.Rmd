...
```{r}
library(readxl)
df <- read_excel("C:\\Users\\Peter Meihuizen\\Desktop\\Masters\\1st Semester\\Data Science\\World Cup Project\\Rugby_matches_data_1984-2023.xlsx")
```
...
Next is a variable for the winner of the game

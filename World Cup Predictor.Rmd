...
Let's decrease the number of teams in each graph so that it is slightly more interpretable. I'm first going to look at all the Southern Hemisphere teams (South Africa, New Zealand, Australia and Argentina). This graph will also show the ranking progression of the last 4 World Cup winning teams, two representing South Africa (2007 and 2019) and two representing New Zealand (2011 and 2015).

```{r}
# Example usage
# Define custom colors for each team
team_colors <- c("South Africa" = "green", "New Zealand" = "black", "Australia" = "yellow", "Argentina" = "lightblue")

# Plot the rankings with custom colors
South_rankings <- plot_rankings(rankings, team_colors)
SA_NZ
